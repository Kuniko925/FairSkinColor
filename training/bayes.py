...
class BayesianRegression:
    ...
    def fit(self, X, y, degree):
        ...
        self.brr_poly = make_pipeline(
            PolynomialFeatures(degree=degree, include_bias=False), # False だと１を消してくれる x[1] ** 2, x[0] * x[2] ** 3 こうなる。
            StandardScaler(),
            BayesianRidge(),
        ).fit(X, y)
