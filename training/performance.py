...
import pandas as pd
from sklearn.metrics import accuracy_score, f1_score, recall_score, confusion_matrix, ConfusionMatrixDisplay, mean_squared_error, mean_absolute_error
...
class PerformanceMeasure:
    ...
    def measure(self):
        ...
        res = {self.col: d_mean, "ACC": acc, "TPR": tpr, "TNR": tnr, "FPR": fpr, "FNR": fnr, "F1": f1}
        df_res = pd.DataFrame(res)
        return df_res

metrics = ["ACC", "TPR", "TNR", "FPR", "FNR", "F1"]
